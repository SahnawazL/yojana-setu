...
export const SCHEME_DB = [
...

  {
    ...
    annual: 5000,
    apply:   { en: "wcd.nic.in", hi: "wcd.nic.in" }, applyType: "offline",
...

  {
    ...
    annual: 3600,
    apply:   { en: "nsap.nic.in", hi: "nsap.nic.in" }, applyType: "offline",
...

  {
    ...
    annual: 0,
    apply:   { en: "pmjdy.gov.in", hi: "pmjdy.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 0,
    apply:   { en: "jansuraksha.gov.in", hi: "jansuraksha.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 0,
    apply:   { en: "nsiindia.gov.in", hi: "nsiindia.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 3600,
    apply:   { en: "nfsa.gov.in", hi: "nfsa.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 12000,
    apply:   { en: "swachhbharatmission.gov.in", hi: "swachhbharatmission.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 0,
    apply:   { en: "aajeevika.gov.in", hi: "aajeevika.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 5000,
    apply:   { en: "pmsma.nhm.gov.in", hi: "pmsma.nhm.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 0,
    apply:   { en: "pmgsy.nic.in", hi: "pmgsy.nic.in" }, applyType: "offline",
...

  {
    ...
    tag:     { en: "Skill / Youth", hi: "कौशल / युवा" },
    annual: 18000,
    apply:   { en: "ddugky.gov.in", hi: "ddugky.gov.in" }, applyType: "offline",
...

  {
    ...
    tag:     { en: "Housing", hi: "आवास" },
    annual: 250000,
    apply:   { en: "pmay2.mohua.gov.in", hi: "pmay2.mohua.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 3600,
    apply:   { en: "pmposhan.education.gov.in", hi: "pmposhan.education.gov.in" }, applyType: "offline",
...

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 0,
    apply:   { en: "soilhealth.dac.gov.in", hi: "soilhealth.dac.gov.in" }, applyType: "offline",
  ...
  // ── Maharashtra ──
  {
    ...
    tag:     { en: "Health", hi: "स्वास्थ्य" },
    annual: 150000,
    apply:   { en: "jeevandayee.gov.in", hi: "jeevandayee.gov.in" }, applyType: "online",
  ...
  // ── Karnataka ──
  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 4000,
    apply:   { en: "raitamitra.kar.nic.in", hi: "raitamitra.kar.nic.in" }, applyType: "online",
  ...
  // ── Telangana ──
  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 20000,
    apply:   { en: "rythubandhu.telangana.gov.in", hi: "rythubandhu.telangana.gov.in" }, applyType: "offline",
  ...
  // ── West Bengal ──
  {
    ...
    tag:     { en: "Women", hi: "महिला" },
    annual: 12000,
    apply:   { en: "socialsecurity.wb.gov.in", hi: "socialsecurity.wb.gov.in" }, applyType: "offline",
  ...
  // ── Assam ──
  {
    ...
    tag:     { en: "Women", hi: "महिला" },
    annual: 15000,
    apply:   { en: "orunodoi.assam.gov.in", hi: "orunodoi.assam.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 60000,
    apply:   { en: "sebaonline.org", hi: "sebaonline.org" }, applyType: "offline",
...

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 5000,
    apply:   { en: "agri.assam.gov.in", hi: "agri.assam.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 0,
    apply:   { en: "wcd.assam.gov.in", hi: "wcd.assam.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 5000,
    apply:   { en: "forest.assam.gov.in", hi: "forest.assam.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 0,
    apply:   { en: "slprb.assam.gov.in", hi: "slprb.assam.gov.in" }, applyType: "online",
  ...
  // ── Himachal Pradesh ──
  {
    ...
    tag:     { en: "Health", hi: "स्वास्थ्य" },
    annual: 36000,
    apply:   { en: "himachal.nic.in/sahara", hi: "himachal.nic.in/sahara" }, applyType: "offline",
  ...
  // ── Chhattisgarh ──
  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 13000,
    apply:   { en: "kisan.cg.nic.in", hi: "kisan.cg.nic.in" }, applyType: "offline",
  ...
  // ── Uttarakhand ──
  {
    ...
    annual: 36000,
    apply:   { en: "wecd.uk.gov.in", hi: "wecd.uk.gov.in" }, applyType: "offline",
  ...
  // ── Karnataka (additional) ──
  {
    ...
    tag:     { en: "Women", hi: "महिला" },
    annual: 24000,
    apply:   { en: "sevasindhuservices.karnataka.gov.in", hi: "sevasindhuservices.karnataka.gov.in" }, applyType: "online",
  ...
  // ── UP (additional) ──
  {
    ...
    annual: 12000,
    apply:   { en: "digishakti.up.gov.in", hi: "digishakti.up.gov.in" }, applyType: "offline",
