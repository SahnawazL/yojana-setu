...
export const SCHEME_DB = [
...

  {
    ...
    annual: 5000,
    apply:   { en: "wcd.nic.in", hi: "wcd.nic.in" }, applyType: "online",
...

  {
    ...
    annual: 12000,
    apply:   { en: "swachhbharatmission.gov.in", hi: "swachhbharatmission.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 5000,
    apply:   { en: "pmsma.nhm.gov.in", hi: "pmsma.nhm.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Skill / Youth", hi: "कौशल / युवा" },
    annual: 18000,
    apply:   { en: "ddugky.gov.in", hi: "ddugky.gov.in" }, applyType: "online",
  ...
  // ── Himachal Pradesh ──
  {
    ...
    tag:     { en: "Health", hi: "स्वास्थ्य" },
    annual: 36000,
    apply:   { en: "himachal.nic.in/sahara", hi: "himachal.nic.in/sahara" }, applyType: "online",
  ...
  // ── Chhattisgarh ──
  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 13000,
    apply:   { en: "kisan.cg.nic.in", hi: "kisan.cg.nic.in" }, applyType: "online",
