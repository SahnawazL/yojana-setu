...
const STRINGS = {
  en: {
    ...
    proFeatures: [
      ...
      { icon:"📦", title:"Document Checklist",        desc:"One consolidated list of every document you need across all matched schemes.",                                                 free:"Simple",     pro:"✓" },
  ...
  hi: {
    ...
    proFeatures: [
      ...
      { icon:"📦", title:"दस्तावेज़ चेकलिस्ट",         desc:"सभी मिलान योजनाओं के लिए एक समेकित दस्तावेज़ सूची।",                                                                        free:"सामान्य",    pro:"✓" },
