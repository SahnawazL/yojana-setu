...
export const ASSAM_SCHEMES = [
...

  {
    ...
    annual: 12000,
    apply:   { en: "site.sebaonline.org", hi: "site.sebaonline.org" }, applyType: "online",
...

  {
    ...
    annual: 40000,
    apply:   { en: "arundhati.nic.in", hi: "arundhati.nic.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "assamfinanceloans.in", hi: "assamfinanceloans.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "silpisanmanassam.com", hi: "silpisanmanassam.com" }, applyType: "online",
...

  {
    ...
    annual: 85000,
    apply:   { en: "mmua.in", hi: "mmua.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "finance.assam.gov.in", hi: "finance.assam.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 3000,
    apply:   { en: "assam.gov.in", hi: "assam.gov.in" }, applyType: "offline",
...

  {
    ...
    annual: 60000,
    apply:   { en: "asrlms.assam.gov.in", hi: "asrlms.assam.gov.in" }, applyType: "offline",
