  ...
  return(
    <div onClick={e=>{if(e.target===e.currentTarget)onClose();}}
      ...
      <div style={{width:"100%",maxWidth:420,margin:"0 auto",background:"#f5f5f0",borderRadius:"24px 24px 0 0",maxHeight:"93vh",overflowY:"auto",transform:visible?"translateY(0)":"translateY(100%)",transition:"transform 0.35s cubic-bezier(0.32,0.72,0,1)",fontFamily:bf}}>
        ...
        <div style={{background:"#fff",padding:"12px 20px 16px",position:"sticky",top:0,zIndex:10,borderBottom:"1px solid #f0f0f0"}}>
          {/* Drag handle */}
          <div style={{display:"flex",justifyContent:"center",marginBottom:14}}>
            <div style={{width:38,height:3.5,background:"#e4e4e4",borderRadius:2}}/>
          </div>
          {/* Title row */}
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16}}>
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              ...
              <div>
                <div style={{fontSize:15,fontWeight:800,color:"#1a1a1a",letterSpacing:-0.2,lineHeight:1,fontFamily:bf}}>{t.checkerTitle}</div>
            ...
            <div onClick={onClose} style={{width:30,height:30,borderRadius:"50%",background:"#f5f5f5",border:"1.5px solid #ebebeb",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontSize:12,color:"#999",fontWeight:700}}>✕</div>
          </div>
...
export default function YojanaSetu(){
  ...
  return(
    <div className="app-root" style={{fontFamily:bf,background:"#f5f5f0",maxWidth:420,margin:"0 auto",position:"relative",display:"flex",flexDirection:"column",overflowX:"hidden",boxShadow:"0 0 60px rgba(0,0,0,0.15)",opacity:langAnim?0.7:1,transition:"opacity 0.12s"}}>
      ...
      {/* Bottom nav */}
      <div className="bnav-wrap" style={{background:"#fff",borderTop:"1.5px solid #f0f0f0",paddingTop:"8px",paddingLeft:"4px",paddingRight:"4px",display:"flex",boxShadow:"0 -4px 20px rgba(0,0,0,0.07)",zIndex:100}}>
        {navItems.map(item=>{
